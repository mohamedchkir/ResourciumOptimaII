    ...
    <link href="${pageContext.request.contextPath}/resources/libs/datatables.net-responsive-bs4/css/responsive.bootstrap4.min.css" rel="stylesheet"
          type="text/css" />

    <!-- preloader css -->
    <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/preloader.min.css" type="text/css" />
    ...
    <!-- dropzone css -->
    <link href="${pageContext.request.contextPath}/resources/libs/dropzone/min/dropzone.min.css" rel="stylesheet" type="text/css" />
    <!-- choice -->
